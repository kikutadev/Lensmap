...
export interface SiteCopy {
  ...
  mapsTitle: string;
  mapsBody: string;
  mapAnatomyLabel: string;
  mapDefinition: string;
  mapDefinitionBody: string;
  evidenceTitle: string;
  selectedEvidenceLabel: string;
  aiEvidenceLabel: string;
  backToPdf: string;
...
export const copy: Record<Locale, SiteCopy> = {
  ja: {
    ...
    mapsBody: "Mapは綺麗な図だけではありません。理解した内容、短い説明、Evidence、元PDFへのbacklinkをひとまとまりにして、読書中に得た理解を再構成できる形で保存します。",
    mapAnatomyLabel: "Mapの構造",
    mapDefinition: "Cache invalidation",
    mapDefinitionBody: "更新後に古くなったキャッシュを無効化し、後続の読み取りで古い値を返さないようにする仕組み。",
    evidenceTitle: "Evidence",
    selectedEvidenceLabel: "あなたが選択",
    aiEvidenceLabel: "AIが追加参照",
    backToPdf: "元のPDFへ戻る",
  ...
  en: {
    ...
    mapsBody: "A Map is more than a pretty diagram. It combines what you understood, a concise explanation, Evidence, and backlinks to the PDF so the reasoning can be reconstructed later.",
    mapAnatomyLabel: "Anatomy of a Map",
    mapDefinition: "Cache invalidation",
    mapDefinitionBody: "A mechanism that invalidates stale cached copies after an update so subsequent reads do not return outdated data.",
    evidenceTitle: "Evidence",
    selectedEvidenceLabel: "Selected by you",
    aiEvidenceLabel: "Added by AI",
    backToPdf: "Back to the source PDF",
